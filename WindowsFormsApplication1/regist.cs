    ...
    public partial class regist : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int id = (int)result+1 ;
                string sex = null;
                if (radioButton1.Text.Trim() != null)
                {
                ...
                else
                {
                   ...
                   /* try
                    {*/
                        sql = "CREATE TABLE " + user + "(ID int NOT NULL,Time CHAR(20) NOT NULL, Score CHAR(10) NOT NULL, Vidio CHAR(50) NOT NULL,primary key (ID))";
                        result = Database.sql_ExecuteNonQuery(sql);
